...
export const metadata = {
  title: "Digital Marketing Services Egypt | Tactics Agency",
  description:
    "Hire digital marketing services in Egypt across SEO, performance marketing, social media and web development with a strategy built around measurable growth.",
  keywords: [
    "digital marketing services Egypt",
    "digital marketing services in Egypt",
    "digital marketing solutions Egypt",
    "online marketing services Egypt",
    "digital marketing company services Egypt",
  ],
  alternates: { canonical: "https://www.tacticsdigitalagency.net/services" },
    ...
    <div className="bg-neutral-950 min-h-screen text-white font-sans selection:bg-[rgb(255,228,0)] selection:text-black">
      ...
      <section className="py-20 lg:py-32 container mx-auto px-4 lg:px-8 text-center border-b border-gray-800">
        <h1 className="text-4xl md:text-6xl font-bold mb-6">
          Digital Marketing <span className="text-[rgb(255,228,0)]">Services in Egypt</span>
        </h1>
